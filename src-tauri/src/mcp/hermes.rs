...
//!
//! Handles conversion between 卡卡AI客户端 unified MCP format and Hermes config.yaml format.
//!
//! ## Format mapping
//!
//! | 卡卡AI客户端 unified (JSON)                        | Hermes config.yaml (YAML)       |
//! |-------------------------------------------------|---------------------------------|
...
/// 卡卡AI客户端 has no OAuth UI, but losing the field on round-trip downgrades
...
// ============================================================================
// Format Conversion: 卡卡AI客户端 -> Hermes
// ============================================================================

/// Convert 卡卡AI客户端 unified format to Hermes format
///
/// Conversion rules:
...
// ============================================================================
// Format Conversion: Hermes -> 卡卡AI客户端
// ============================================================================

/// Convert Hermes format to 卡卡AI客户端 unified format
///
/// Conversion rules:
...
/// `existing` — this prevents 卡卡AI客户端 from overwriting user customizations.
...
mod tests {
    ...
    fn test_merge_preserves_auth_field() {
        ...
        assert_eq!(
            merged["auth"], "oauth",
            "auth declaration must survive 卡卡AI客户端 round-trip"
        );
    }
