//! Deep link import functionality for 卡卡AI客户端
//!
//! This module implements the kakaai:// protocol for importing configurations
...
///
/// Represents a parsed kakaai:// URL ready for processing.
