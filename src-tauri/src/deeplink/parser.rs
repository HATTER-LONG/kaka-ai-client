...
//!
//! Parses kakaai:// URLs into DeepLinkImportRequest structures.
...
/// Parse a kakaai:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// kakaai://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "kakaai" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'kakaai', got '{scheme}'"
        )));
    }
