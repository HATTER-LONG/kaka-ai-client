...
/**
 * Hermes Agent configuration API (卡卡AI客户端 side).
 *
 * 卡卡AI客户端 intentionally keeps its Hermes surface minimal — deep configuration
 * (model, agent behavior, env vars, skills, cron, logs, analytics) lives in
 * the Hermes Web UI at http://127.0.0.1:9119. 卡卡AI客户端 only reads the `model`
